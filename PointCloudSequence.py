...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, URI, initial_x, initial_y, initial_z, initial_yaw):
        ...
        self.canvas = Canvas(self.run_sequence)
    ...
    def set_initial_position(self):
        self.cf.param.set_value('kalman.initialX', self.initial_x)
...
class Canvas(scene.SceneCanvas):
    ...
    def on_key_press(self, event):
        ...
        if (not event.native.isAutoRepeat()):
            if (event.native.key() == QtCore.Qt.Key_Space):
                self.keyCB(sequence)
...
if __name__ == '__main__':
    ...
    win = MainWindow(URI, initial_x, initial_y, initial_z, initial_yaw)
    win.show()
    appQt.exec_()